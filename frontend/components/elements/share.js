        ...
        <div className="flex justify-between text-sm mt-4 mb-2">
          <div className="flex gap-1">
            ...
            >
              <a
                target="_blank"
                onClick="gtag('event', 'detay', {'event_category': 'share','event_label': 'telegram'});"
            ...
            >
              <a
                target="_blank"
                onClick="gtag('event', 'detay', {'event_category': 'share','event_label': 'whastapp'});"
            ...
            >
              <a
                ...
                onClick="gtag('event', 'detay', {'event_category': 'share','event_label': 'facebook'});"
            ...
            >
              <a
                ...
                onClick="gtag('event', 'detay', {'event_category': 'share','event_label': 'twitter'});"
          ...
          <div className="flex flex-row items-center gap-2 text-midgray">
            <span>Abone Ol</span>
            <Link href="https://news.google.com/publications/CAAiEATMSmX53ZjtQ4kcyzxQ1_IqFAgKIhAEzEpl-d2Y7UOJHMs8UNfy">
              <a
                target="_blank"
                title="Twitter ile paylaş"
                onClick="gtag('event', 'detay', {'event_category': 'share','event_label': 'googlenews'});"
